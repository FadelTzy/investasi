                    ...
                    <form id="datatipe" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="jenis" required placeholder="Input Nama" class="form-control">
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="bulan" required placeholder="Input Bulan " class="form-control">
                            </div>
                            <br>
                            <label for="Nama">Persenan</label>

                            <div class="input-group">
                                <input type="text" name="persenan" required placeholder="Input persenan" class="form-control ">
                            </div>
                            <br>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="jenis" id="jenisu" required placeholder="Input Nama" class="form-control">
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="bulan" id="bulanu" required placeholder="Input Bulan " class="form-control">
                                </div>
                                <br>
                                <label for="Nama">Persenan</label>
    
                                <div class="input-group">
                                    <input type="text" name="persenan" id="persenanu" required placeholder="Input persenan" class="form-control ">
                                </div>
                                <br>
...
@push('js')
    ...
    <script>
        ...
        function staffupd(id) {
            ...
            $("#jenisu").val(id.periodik);
            $("#persenanu").val(id.persenan);
            $("#bulanu").val(id.bulan);
